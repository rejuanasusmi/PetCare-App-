...
public class ShopForget extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_forget);
        ...
        ClickableSpan clickspan = new ClickableSpan() {
            ...
            public void onClick(@NonNull View widget) {
                Intent i = new Intent(getApplicationContext(),ShopLogInActivity.class);
                startActivity(i);
            }
        };
            ...
            mAuth.sendPasswordResetEmail(emailR).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(ShopForget.this, "Check Your Email", Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(getApplicationContext(),ShopLogInActivity.class);
                        startActivity(i);
                    }
                    else{
                        Toast.makeText(ShopForget.this, "Error"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
